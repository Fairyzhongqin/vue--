<template>
  <div class="judgeNowtable-2">
    <el-table :data="tableData" border style="width: 100%" v-loading="loading" row-key="deptCode" lazy
      ...
      <el-table-column prop="deptName" label="所属区域" align="left" show-overflow-tooltip></el-table-column>
      <el-table-column prop="4" label="立案数"></el-table-column>
      <el-table-column prop="5" label="结案数"></el-table-column>
      <el-table-column prop="6" label="处罚决定数"></el-table-column>
      <el-table-column prop="7" label="罚款金额"></el-table-column>
    </el-table>
  </div>
</template>
<script>
