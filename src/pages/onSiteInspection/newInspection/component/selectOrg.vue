...
export default {
  ...
  methods: {
    ...
    sure() {
      if(this.selectedOrg && this.selectedOrg !== "") {
        ...
        console.log(this.defaultDept, '99999999999')
      }
    },
    close() {
      this.closeOrgDialog();
  ...
  mounted() {
    ...
    if(this.userOrgEntity){
       this.deptInfo = this.userOrgEntity;
    }else{
       this.deptInfo = JSON.parse(sessionStorage.getItem("userInfo")).sysDeptEntity;
    }
