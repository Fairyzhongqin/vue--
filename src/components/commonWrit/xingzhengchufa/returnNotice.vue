<template>
  <div>
    <div class="return-notice_content writ-overflow">
      <el-form ref="notice" :model="notice" :rules="rules" label-width="158px" label-position="right" :show-message="false">
    ...
    <div class="dialog-footer" style="text-align: right">
      ...
      <el-button type="primary" @click="sure">保存并生成处罚告知书送达回执</el-button>
        ...
        .then(info => {
          info.data.forEach(tag => {
            if (tag.tagName === 'tag15') {
              // 送达方式
              this.notice.way = tag.tagContent == 'true' ? '直接送达' : '邮寄送达'
            }
          })
        })
